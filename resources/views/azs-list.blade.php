            ...
            <!-- You can dynamically generate breadcrumbs here -->
                ...
                <section class="content-header"  style="margin: 10px">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="active">A3C</li>
                    <li class="active"><a href="{{url("add-azs")}}" class="btn btn-primary" style="color: #FFF">Добавить A3C</a> </li>
                  </ol>
                </section>
                          ...
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            @foreach($list as $item)
                                <tr>
                                  ...
                                  <td> <a href="{{url("edit_azs/".$item->id)}}"> Редактировать </a></td>
                                  <td> <a href="{{url("delete_azs/".$item->id )}}"> Удалить </a></td>
                                </tr>
                            @endforeach
                            </tbody>
                          </table>
