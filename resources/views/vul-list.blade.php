...
<html>
    <head>
        <meta charset="UTF-8">
        <title>{{ $page_title or "Админ Панель" }}</title>
            ...
            <!-- You can dynamically generate breadcrumbs here -->
                ...
                <section class="content-header"  style="margin: 10px">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="active">Вулканизация</li>
                    <li class="active"><a href="{{url("add-vul")}}" class="btn btn-primary" style="color: #FFF">Добавить Вулканизацию</a> </li>
                  </ol>
                </section>
                          ...
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            @foreach($list as $item)
                                <tr>
                                  ...
                                  <td> <a href="{{url("edit_vul/".$item->id)}}"> Редактировать </a></td>
                                  <td> <a href="{{url("delete_vul/".$item->id )}}"> Удалить </a></td>
                                </tr>
                            @endforeach
                            </tbody>
                          </table>
