            ...
            <!-- You can dynamically generate breadcrumbs here -->
                ...
                <section class="content-header"  style="margin: 10px">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="active">Камеры</li>
                    <li class="active"><a href="{{url("add-camera")}}" class="btn btn-primary" style="color: #FFF">Добавить камеру</a> </li>
                  </ol>
                </section>
                          ...
                          <table id="example2" class="table table-bordered table-hover">
                            ...
                            @foreach($list as $item)
                                <tr>
                                  ...
                                  <td> <a href="{{url("edit_camera/".$item->id)}}"> Редактировать </a></td>
                                  <td> <a href="{{url("delete_camera/".$item->id )}}"> Удалить </a></td>
                                </tr>
                            @endforeach
                            </tbody>
                          </table>
