...
<div class="row">
        <div class="col-md-6">
          ...
          <form action="{{url("add_azs_item")}}" method="post">
          <div class="box box-danger">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                              <label>Тип топливо:</label>

                              <div class="input-group">
                                <div class="input-group-addon">
                                  <i class="fa"></i>
                                </div>
                                <select class="form-control" name="gasoline_type" id="gasoline_type">

                                                                   <option value="Бензин" @if($item->gasoline_type=='Бензин') selected @else @endif >Бензин</option>
                                                                   <option value="Газ"@if($item->gasoline_type=='Газ') selected @else @endif >Газ</option>
                                                                   <option value="Дизель"@if($item->gasoline_type=='Дизель') selected @else @endif >Дизель</option>
                                                                </select>
              ...
              <div class="box-footer">
                                                              <button type="submit" class="btn btn-primary">Изменить A3C</button>
                                                            </div>
              <!-- /.form group -->
